...
public class ViewPoligono extends javax.swing.JFrame {

    FiguraController controlador;
    
    public ViewPoligono() throws SQLException {
    ...
    private void initComponents() {
        ...
        txtcantLado = new javax.swing.JTextPane();
        ...
        jLabel3.setText("Cantidad lados:");

        jScrollPane1.setViewportView(txtcantLado);

        jLabel4.setText("Medida lado:");

        jScrollPane2.setViewportView(txtLado);
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        try{
            double CantLado = Float.parseFloat(txtcantLado.getText());
            double Lado = Float.parseFloat(txtLado.getText());
            
            double Perimetro = controlador.calcularPerimetroPoligono((int) CantLado, Lado);
            double Area = controlador.calcularAreaPoligono((int) CantLado, Lado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPoligono.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ViewPoligono().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(ViewPoligono.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    private javax.swing.JTextPane txtcantLado;
