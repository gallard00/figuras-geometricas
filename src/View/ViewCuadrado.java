...
public class ViewCuadrado extends javax.swing.JFrame {
    FiguraController controlador;
    
    public ViewCuadrado() throws SQLException {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(txtLado);
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        try{
            double Lado = Float.parseFloat(txtLado.getText());
            
            double resultadoPerimetro = controlador.calcularPerimetroCuadrado(Lado);
            double resultadoArea = controlador.calcularAreaCuadrado(Lado);
            
            lblPerimetro.setText(String.valueOf(resultadoPerimetro));
            lblArea.setText(String.valueOf(resultadoArea));
            
        }catch(NumberFormatException exception){
            JOptionPane.showMessageDialog(this, "Por favor, ingrese un numero valido para el lado del cuadrado.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCuadrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ViewCuadrado().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(ViewCuadrado.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private javax.swing.JTextPane txtLado;
